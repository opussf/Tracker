...
function TRACKER.OnUpdate(arg1)
	print("Tracker> OnUpdate("..arg1..")")
end
----------
...
function TRACKER.BAG_UPDATE()
	...
	for itemID, _ in pairs(TRACKER_data) do
		...
		local inAccount = C_Item.GetItemCount( itemID, false, false, false, true ) - youHave
		...
		TRACKER_data[itemID].account = inAccount -- WBB
		...
		print("youHave: "..youHave..", inAccount: "..inAccount..", playerTotal: "..playerTotal)
